...
> Visite a página clicando [aqui](https://zkd-clone-disneyplus.netlify.app/ "Visitar página").
...
Nesse projeto foi criado a página inteira da Disney+, nele foi utilizado alguns pacotes do Node.js, sendo eles **SASS** e **Gulp**. Infelizmente não consegui deixar de fora a pasta **Dist**, porque houve um erro no envio das imagens pelo Gulp e elas não carregavam no site, no entanto,
eu sei que não pode deixar essa pasta em um repositório, pois meus tutores sempre reforçam isso, mas enfim, apenas estou informando que sei o que estou fazendo.
Caso ainda não tenha visto a página, clique [aqui](https://zkd-clone-disneyplus.netlify.app/ "Visitar página").
